...
class BoardTopics(TestCase):
    ...
    def setUp(self):
        Board.objects.create(name='Django',description='All things related thisframework')
    ...
    def test_home_view_not_found_status_code(self):
    ...
    def test_board_topic_view_contains_link_to_home_page(self):
